...
import com.rvtech.turbovpn.vpn.dialog.RegionChooserDialog;
                ...
                if (aBoolean) {
                    ...
                    UnifiedSDK.getInstance().getVPN().start(new SessionConfig.Builder()
                        ...
                        public void complete() {
                            ...
                            vpn_connect_btn.setImageResource(R.drawable.ic_vpn_connected);
    ...
    protected void disconnectFromVnp() {
        ...
        UnifiedSDK.getInstance().getVPN().stop(TrackingConstants.GprReasons.M_UI, new CompletableCallback() {
            ...
            public void complete() {
                ...
                Toasty.success(MainActivity.this, "VPN DisConnected!", Toast.LENGTH_SHORT, true).show();
